        ...
        while(true) {
            try {
                ...
                if(p.getType() == 1) {
                    ...
                    Packet.send(out, new Packet(p.getDestination(), p.getSource(), 5, "1 null".getBytes(StandardCharsets.UTF_8)));
                } else if (p.getType() == 6) {
                    ...
                    Packet.send(out, new Packet(p.getDestination(), p.getSource(), 17, msg.getBytes(StandardCharsets.UTF_8)));
